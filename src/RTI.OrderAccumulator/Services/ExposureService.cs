...
public class ExposureService
{
    ...
    public ExposureService(IExposureRepository exposureRepository, IOrderRepository orderRepository, ILogger<ExposureService> logger)
    {
        ...
        string status)
    {
        ...
        if (status == "ACCEPTED")
        {
            ...
            _logger.LogInformation("Exposure updated for symbol {Symbol}: {ExposureValue}", symbol, exposureValue);
        }
    }
}